/**
 * Shown while /settings/egress's code is being fetched on navigation.
 *
...
export default function SettingsEgressLoading() {
  return <LoadingState label="Loading the egress ledger…" />;
}
