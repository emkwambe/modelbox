...
**Evidence:**
`test_migration_0013_populated.py::test_migration_0013_preserves_every_artifact_byte_for_byte`.
All five reference models are seeded into a real PostgreSQL 16 by the **previous
release's code** at the previous schema revision, every artifact is generated and
SHA-256'd — DDL across 7 dialects, dbt, Cube, LookML, MetricFlow, ODCS, Avro,
Protobuf, three dictionary formats, two seed formats — the schema is migrated,
and everything is regenerated by the new code and compared hash for hash.
